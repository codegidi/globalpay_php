...
class GlobalPay_Transaction {
    ...
    public function initiation($returnurl,$merchantreference,$merchantid,$description,$totalamount,$currencycode,$customerEmail,$customerNumber,$customerFirstName,$customerLastName){
